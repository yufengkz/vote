(function(){
    ...
    Load.prototype.loadAction = function() {
        ...
        window.onscroll = function() {
            var realHeight = (document.documentElement.clientHeight || document.body.clientHeight) + Math.ceil((document.documentElement.scrollTop || document.body.scrollTop));
        ...
        this.end = function(e) {
            //console.log('this.end',_this.updateFlag);
            if(_this.updateFlag) {
